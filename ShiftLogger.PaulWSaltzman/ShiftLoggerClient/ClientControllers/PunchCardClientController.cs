...
internal class PunchCardClientController
{
    ...
    //internal static ShiftDTO RemoveShiftDTO(ShiftDTO shiftDTO)
    //{
    //    HttpClient client = new HttpClient();
    //    client.BaseAddress = new Uri("https://localhost:7196");
    //    client.DefaultRequestHeaders.Accept.Clear();
    ...
    //        HttpResponseMessage response = client.PutAsync($"api/shift/byemployee/{shiftDTO.Id}", content).Result;
    //        response.EnsureSuccessStatusCode();
    ...
    //internal static ShiftDTO RemovePunchOut(ShiftDTO closingShift)
    //{
    //    HttpClient client = new HttpClient();
    //    client.BaseAddress = new Uri("https://localhost:7196");
    //    client.DefaultRequestHeaders.Accept.Clear();
    ...
    //    try
    //    {
    //        string jsonShift = JsonConvert.SerializeObject(closingShift);
    //        StringContent content = new StringContent(jsonShift, Encoding.UTF8, "application/json");

    //        HttpResponseMessage response = client.PutAsync($"api/shift/{closingShift.Id}", content).Result;
    //        response.EnsureSuccessStatusCode();
