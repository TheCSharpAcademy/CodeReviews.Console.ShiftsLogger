...
public class FrontEndShiftService : FrontEndIShiftService
{
    private readonly HttpClient _httpClient;
    private readonly IMapper _mapper;

    public FrontEndShiftService(HttpClient httpClient, IMapper mapper)
    {
    ...
    public async Task<ApiResponseDto<ShiftsDto>> CreateShift(ShiftApiRequestDto shift)
    {
        try
        {
            ...
            {
                ApiResponseDto<ShiftsDto>? result = await response.Content.ReadFromJsonAsync<ApiResponseDto<ShiftsDto>>();
                return result
    ...
    public async Task<ApiResponseDto<ShiftsDto>> UpdateShift(int id, ShiftApiRequestDto updatedShift)
    {
        try
        {
            ...
            {
                ApiResponseDto<ShiftsDto?>? errorResponse = await response.Content.ReadFromJsonAsync<
                    ApiResponseDto<ShiftsDto?>
                >();
                return new ApiResponseDto<ShiftsDto?>
                {
